	...
	tests:= []GetCoorDistanceTests{
		{
			...
			models.Center{Long: -36.1414237, Lat: -59.7854004}, 
			160.765761,
		},
		{
			models.Center{Long: 54.4828045, Lat: -312.1237794}, 
			models.Center{Long: 54.4904641, Lat: -311.7656207}, 
			39.827583,
		},
		{
			models.Center{Long: 54.8380309, Lat: -476.8637697}, 
			models.Center{Long: 54.8194413, Lat: -476.8588257}, 
			1.083700,
		},
	}
...
func TestIsSameCoor(t *testing.T){
	...
	tests := []IsSameCoorTest{
			{
				models.Center{Long: -36.0233352, Lat: -61.2301026}, 
				models.Center{Long: -36.0233352, Lat: -59.7854004}, 
				false,
			},
			{
				models.Center{Long: 54.4828045, Lat: -312.1237794}, 
...
func TestIsInInfluenceArea(t *testing.T){
	...
	basePeer := models.Peer{
		Url: "http://test.com",
		Center: models.Center{Long: -36.0233352, Lat: -61.2301026},
		City: "test city",
		Country: "test country",
	}
	peer1 := basePeer
	peer1.Center = models.Center{Long: -32.0233352, Lat: -61.2301026}

	peer2 := basePeer
	peer2.InfluenceRadius= 1
	peer2.DeliveryRadius=2
	peer2.Center= models.Center{Long: -34.605447, Lat: -58.383594}

	peer3 := peer2
	peer3.Center= models.Center{Long: -34.605341, Lat: -58.386598}

	peer4 := peer2
	peer4.Center= models.Center{Long: -34.606716, Lat: -58.470303}
